...
class LstmNet(t.nn.Module): # Lstm 网络
    def __init__(self, input_size, hidden_size, num_layers, num_classes):
        ...
        self.lstm = t.nn.LSTM(input_size, hidden_size, num_layers, batch_first=True) # Lstm层
    ...
    def forward(self, x):
        ...
        lstm_out, _ = self.lstm(x, (h0, c0)) # lstm输出
...
X_val = X_val.view(10000, -1, 28 * 28) # 整形成CNN要求的格式

out_val = model(X_val) # 用训练好的模型计算结果
loss_val = t.nn.CrossEntropyLoss()(out_val, y_val) # 验证交叉熵
